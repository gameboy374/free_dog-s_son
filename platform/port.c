...
int SPI_Configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = DW_GPIO5_SPIPOL_Pin|DW_GPIO6_SPIPHA_Pin;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	...
	//Set SPI POL/PHA
    GPIO_ResetBits(DW_GPIO5_SPIPOL_GPIO_Port, DW_GPIO5_SPIPOL_Pin);
    GPIO_ResetBits(DW_GPIO6_SPIPHA_GPIO_Port, DW_GPIO6_SPIPHA_Pin);
